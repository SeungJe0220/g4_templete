...
int main(int argc, char **argv)
{
  ...
  {
    // interactive mode
    UImanager->ApplyCommand("/control/execute vis.mac"); // hard-coded, run to GUI macro file and we will have enterd to commands
    ui->SessionStart();
    delete ui;
  }
  else
  {
    // batch mode
    G4String command = "/control/execute "; // batch mode, In this case, we will have entered command in terminal
